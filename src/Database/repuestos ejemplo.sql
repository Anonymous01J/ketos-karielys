...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-02-2026 a las 23:59:37
...
(1, 'Filtros de aceite'),
(2, 'Filtros de aire'),
(23, 'Filtros de aire deportivos'),
(3, 'Filtros de combustible'),
(17, 'Kits de arrastre'),
(19, 'Neumáticos'),
(5, 'Pastillas de freno'),
(18, 'Pastillas de freno moto');
...
INSERT INTO `productos` (`id`, `id_categoria`, `nombre`, `descripcion`, `marca`, `precio`, `stock`, `stock_minimo`, `stock_maximo`, `imagen`, `estado`) VALUES
(1, 1, 'Filtro de aceite Toyota', 'Filtro de aceite para motores Toyota 1.6/1.8', 'Toyota', 10.00, 0, 3, 20, '', 1),
(2, 2, 'Filtro de aire Chevrolet Aveo', 'Filtro de aire para Aveo y Optra', 'ACDelco', 15.00, 0, 2, 15, NULL, 1),
(3, 3, 'Filtro de combustible Ford Fiesta', 'Filtro de gasolina de alta eficiencia', 'Motorcraft', 18.00, 0, 2, 10, NULL, 1),
(4, 4, 'Bujías Iridium NGK', 'Juego de 4 bujías Iridium', 'NGK', 28.00, 0, 4, 25, NULL, 1),
(5, 5, 'Pastillas de freno Corolla', 'Pastillas delanteras para Toyota Corolla', 'TRW', 35.00, 0, 2, 10, NULL, 1),
(6, 6, 'Discos de freno Hyundai Elantra', 'Par de discos ventilados', 'Hyundai', 75.00, 0, 1, 6, NULL, 1),
(7, 7, 'Amortiguador Delantero Hilux', 'Amortiguador reforzado', 'KYB', 95.00, 0, 1, 5, NULL, 1),
(8, 8, 'Batería 600CCA', 'Batería automotriz libre de mantenimiento', 'Titanium', 85.00, 0, 2, 10, NULL, 1),
(9, 9, 'Correa única Chevrolet', 'Correa de accesorios para Chevrolet', 'Gates', 22.00, 0, 3, 15, NULL, 1),
(10, 10, 'Bomba de agua Mitsubishi', 'Bomba de agua para motores 2.0', 'Mitsubishi', 60.00, 0, 1, 5, NULL, 1),
(11, 16, 'Cadena reforzada 428H', 'Cadena para motos 150cc', 'DID', 20.00, 0, 5, 30, NULL, 1),
(12, 17, 'Kit de arrastre Empire 150', 'Kit completo: piñón, corona y cadena', 'Empire', 35.00, 0, 3, 20, NULL, 1),
(13, 18, 'Pastillas de freno para moto', 'Pastillas delanteras universales', 'Venezolana', 8.00, 0, 5, 40, NULL, 1),
(14, 19, 'Neumático 90/90-17', 'Caucho delantero para motos 150cc', 'Pirelli', 45.00, 0, 2, 10, NULL, 1),
(15, 20, 'Bujía NGK CR7HSA', 'Bujía estándar para motos 125-150cc', 'NGK', 6.00, 0, 10, 50, NULL, 1),
(16, 21, 'Amortiguador trasero universal', 'Amortiguador para motos tipo paseo', 'RacingBoy', 30.00, 0, 2, 15, NULL, 1),
(17, 22, 'Carburador para moto 150cc', 'Carburador tipo PZ27', 'Keihin', 38.00, 0, 1, 8, NULL, 1),
(18, 23, 'Filtro de aire deportivo', 'Filtro cónico para motos', 'ProFilter', 12.00, 0, 5, 30, NULL, 1),
(19, 24, 'Aceite 20W50 para moto', 'Aceite mineral 20W50', 'Venoco', 7.00, 0, 10, 60, NULL, 1),
(20, 25, 'Espejos retrovisores universales', 'Par de espejos cromados', 'Universal', 10.00, 0, 4, 25, NULL, 1);
